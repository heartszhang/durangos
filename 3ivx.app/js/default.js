(function () {
    ...
    try {
        if (WinJS.Utilities.hasWinRT && Windows.Xbox) {
          hlsAdapter = new HlsBy3ivx.HlsAdapter('3300A81D', '1ef70100-41f9-49ca-9867-77c23300a81d', '0ab7-f5ed-db24-fa4f-2f74-ed8d-3789-df8d-7532-9d8e'); 
        } else {
            hlsAdapter = new HlsBy3ivx.HlsAdapter('3ivx.Samples.HlsDemo', 'CN=3ivx HLS Evaluation - NOT FOR DISTRIBUTION', '5f2a-5c9b-8fd2-2b59-b78a-8f17-972d-89a7-76db-9d12');
        }
    }
    catch (err) {
        // handle errors
    ...
    MyApp.Utilities.User.appHomePage = "/pages/main/main.html";
