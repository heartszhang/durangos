#pragma once
#include "hls.wrap_h.h"  // generated by midl
#include <functional>
...
typedef std::function<HRESULT( IMFAsyncResult* )> InvokeFunT;
...
inline DWORD FlagsWithoutLocal(DWORD flags) {
