...
(function () {
    ...
    function buttonTestClicked(eventInfo) {
      ...
      control.mediaElementAdapter = new HlsMedia.HlsMediaElementAdapter(control, me, false);
      control.mediaElementAdapter.setHlsMedia(url, 0);
    };
